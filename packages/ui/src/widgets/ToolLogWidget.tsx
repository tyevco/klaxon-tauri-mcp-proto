      ...
      <div style={{ display: "flex", gap: 6, marginBottom: 8, alignItems: "center", flexWrap: "wrap" }}>
        <select
          ...
          style={{
            ...
            borderRadius: 6, padding: "3px 8px", color: "var(--text)", fontSize: 11,
          }}
        >
        ...
        <button
          onClick={async () => { await invoke("toollog_clear"); setEntries([]); }}
          style={{
            fontSize: 11, padding: "3px 8px", borderRadius: 6, cursor: "pointer",
          ...
          return (
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <span style={{ fontSize: 10, opacity: 0.4, whiteSpace: "nowrap" }}>{relTime(e.called_at)}</span>
              </div>
              {!isExpanded && (
                <div style={{ fontSize: 10, opacity: 0.55, marginTop: 2, fontFamily: "monospace", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                  {e.args_summary}
                </div>
              )}
              {isExpanded && (
                <div style={{ marginTop: 6, fontSize: 11 }}>
                  ...
                  <div style={{ fontFamily: "monospace", padding: "4px 6px", background: "var(--bg)", borderRadius: 4, wordBreak: "break-all" }}>
                    {e.args_summary}
                  </div>
                  {e.error && (
